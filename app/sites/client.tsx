  ...
  <button
    ...
    className={`cursor-pointer rounded-full px-4 py-2 text-sm font-medium transition-all duration-300 sm:px-5 sm:py-2.5 sm:text-base ${
      isSelected
        ...
        : "border border-gray-200 bg-gray-50 text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:border-white/10 dark:bg-white/5 dark:text-gray-400 dark:hover:bg-white/10 dark:hover:text-white"
    }`}
  >
    {label}
...
const EmptyState = ({ onViewAll }: { onViewAll: () => void }) => (
  <div className="py-16 text-center sm:py-20">
    <div className="mx-auto max-w-md">
      ...
      <button
        onClick={onViewAll}
        className="mt-6 rounded-full border border-gray-200 bg-gray-50 px-6 py-3 text-sm font-medium text-gray-700 transition-all duration-300 hover:bg-gray-100 hover:text-gray-900 dark:border-white/10 dark:bg-white/5 dark:text-gray-300 dark:hover:bg-white/10 dark:hover:text-white"
      >
        View All Sites
      </button>
    </div>
