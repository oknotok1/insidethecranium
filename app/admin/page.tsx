...
const Loading = () => (
  <main className="flex flex-col">
    <section className="flex items-center justify-center py-8 sm:py-12 lg:py-14">
      ...
      <div className="w-full max-w-md px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-100 p-6 dark:border-white/10 dark:bg-white/5">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-3 font-medium text-gray-700 transition-all duration-200 hover:scale-105 hover:bg-gray-50 hover:shadow-lg active:scale-100 dark:border-white/20 dark:bg-black/20 dark:text-white dark:hover:bg-black/30"
          >
  ...
  <div className="rounded-lg border border-gray-200 bg-gray-100 p-4 sm:p-6 dark:border-white/10 dark:bg-white/5">
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
      <Link
        ...
        className="inline-flex items-center gap-2 rounded-lg bg-[#3d38f5] px-4 py-2 text-sm font-medium text-white transition-all duration-200 hover:scale-105 hover:bg-[#2e29cc] hover:shadow-lg active:scale-100 sm:text-base dark:bg-[#8b87ff] dark:hover:bg-[#7b77ef]"
      >
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-all duration-200 hover:scale-105 hover:bg-gray-50 hover:shadow-lg active:scale-100 sm:text-base dark:border-white/20 dark:bg-black/20 dark:text-white dark:hover:bg-black/30"
      >
        <svg
          className="h-4 w-4"
          fill="none"
