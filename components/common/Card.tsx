...
const baseClasses =
  "group relative flex flex-col overflow-hidden bg-gray-50 dark:bg-white/6 hover:bg-gray-100 dark:hover:bg-white/11 rounded-lg transition-all duration-300";
